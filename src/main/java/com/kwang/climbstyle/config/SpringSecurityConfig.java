    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/menus").hasAuthority(RoleCode.ROLE_ADMIN.getCode())
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/menus/*").hasAuthority(RoleCode.ROLE_ADMIN.getCode())
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/menus/*").hasAuthority(RoleCode.ROLE_ADMIN.getCode())
