...
public enum UserErrorCode implements ApiCode {
    ...
    USER_EMAIL_VERIFICATION_CODE_MISMATCH(HttpStatus.BAD_REQUEST, "4013", "인증번호가 올바르지 않습니다."),
    USER_EMAIL_VERIFICATION_EXPIRED(HttpStatus.BAD_REQUEST,       "4014", "인증번호가 만료되었습니다. 다시 발송해주세요."),
    USER_EMAIL_NOT_VERIFIED(HttpStatus.BAD_REQUEST,               "4015", "이메일 인증을 완료해주세요."),
