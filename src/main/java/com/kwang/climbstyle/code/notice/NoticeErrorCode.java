...
public enum NoticeErrorCode implements ApiCode {
    ...
    NOTICE_FILE_COUNT_EXCEEDED(HttpStatus.BAD_REQUEST,        "6005", "공지사항 첨부파일은 최대 5개까지 첨부 가능합니다."),
    NOTICE_FILE_SIZE_EXCEEDED(HttpStatus.BAD_REQUEST,         "6006", "첨부파일 크기는 10MB 이하만 가능합니다."),
    NOTICE_FILE_INVALID_FORMAT(HttpStatus.BAD_REQUEST,        "6007", "허용되지 않는 파일 형식입니다."),
    NOTICE_DEFAULT_ERROR(HttpStatus.BAD_REQUEST,              "6008", "공지사항 입력값 형식이 잘못되었습니다."),
