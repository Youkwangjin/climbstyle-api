...
import com.kwang.climbstyle.domain.auth.dto.request.AdminLoginRequest;
...
public class CustomAdminJsonAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomAdminJsonAuthenticationFilter(
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        AdminLoginRequest loginRequest = objectMapper.readValue(StreamUtils.copyToString(request.getInputStream(),
                StandardCharsets.UTF_8), AdminLoginRequest.class);
